...
<head>
	...
	<title>Store |Vidagua Club</title>
...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcroumb-title text-center">
						<h1>Store </h1>
						<h6><a href="index.php">Home</a> / Store</h6>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="portfolio-area section-padding">
		<div class="container">
			<div class="row">
            <p>Support clean water in style with gifts that make our work possible. Profits from each item will fund our operating costs and help us grow.
            Click here to visit Vidagua store.</p>

            <a href="https://squareup.com/dashboard/items/library" class="main-btn" style="color:white;">Visit Sotre</a>
